                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        ...
                        <div className="max-w-sm mb-4">
                            <h2 className="text-3xl font-light leading-tight mb-4 tracking-tight font-['Manrope',sans-serif]">
                                ...
                                <span className="font-semibold text-[#C9A96E]">Join the Future.</span>
                            </h2>
                            <p className="text-[#7A6E63] text-sm leading-relaxed font-light font-['Inter',sans-serif]">
                                Experience curated collections, exclusive drops, and a seamless shopping experience.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 p-6 sm:p-8 flex flex-col justify-center bg-white relative overflow-y-hidden overflow-x-hidden  custom-scrollbar">
                    ...
                    <div className="max-w-[400px] w-full mx-auto relative z-10">
                        <div className="text-center lg:text-left mb-6">
                            <h2 className="text-2xl font-bold text-[#1b1c1a] tracking-tight font-['Manrope',sans-serif]">Create Account</h2>
                            <p className="text-[#7A6E63] mt-1 text-sm font-['Inter',sans-serif]">Join Snitch to elevate your wardrobe</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className={`block w-full px-4 pt-5 pb-1.5 text-sm text-neutral-900 bg-neutral-50 border rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-neutral-900/20 focus:bg-white transition-all peer
                                            ${errors.fullName ? 'border-red-500 focus:border-red-500' : 'border-neutral-200 focus:border-neutral-900'}`}
                                    />
                                    <label 
                                        htmlFor="fullName" 
                                        className={`absolute text-sm duration-300 transform -translate-y-1/2 scale-75 top-3.5 z-10 origin-[0] left-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:top-1/2 peer-focus:top-3.5 peer-focus:scale-75 peer-focus:-translate-y-1/2 pointer-events-none
                                            ${errors.fullName ? 'text-red-500' : 'text-neutral-500 peer-focus:text-neutral-900'}`}
                                    >
                                        Full Name
                                    </label>
                                </div>
                                {errors.fullName && <p className="mt-1 text-xs text-red-500 flex items-center"><span className="inline-block w-1 h-1 bg-red-500 rounded-full mr-1.5"></span>{errors.fullName}</p>}
                            </div>
                            ...
                            <div>
                                <div className="relative group">
                                    <input
                                        ...
                                        placeholder=" "
                                        className={`block w-full px-4 pt-5 pb-1.5 text-sm text-neutral-900 bg-neutral-50 border rounded-xl appearance-none focus:outline-none focus:ring-2 focus:ring-neutral-900/20 focus:bg-white transition-all peer
                                            ${errors.contactNumber ? 'border-red-500 focus:border-red-500' : 'border-neutral-200 focus:border-neutral-900'}`}
                                    />
                                    <label 
                                        htmlFor="contactNumber" 
                                        className={`absolute text-sm duration-300 transform -translate-y-1/2 scale-75 top-3.5 z-10 origin-[0] left-4 peer-placeholder-shown:scale-100 peer-placeholder-shown:top-1/2 peer-focus:top-3.5 peer-focus:scale-75 peer-focus:-translate-y-1/2 pointer-events-none
                                            ${errors.contactNumber ? 'text-red-500' : 'text-neutral-500 peer-focus:text-neutral-900'}`}
                                    >
                                        Contact Number
                                    </label>
                                </div>
                                {errors.contactNumber && <p className="mt-1 text-xs text-red-500 flex items-center"><span className="inline-block w-1 h-1 bg-red-500 rounded-full mr-1.5"></span>{errors.contactNumber}</p>}
                            </div>
                            ...
                            <div className="pt-0.5">
                                <label className="flex items-start cursor-pointer group/seller">
                                    <div className="relative flex items-center justify-center w-4 h-4 mt-0.5 mr-2.5 border-2 border-neutral-300 rounded-[4px] group-hover/seller:border-neutral-900 transition-colors">
                                        <input
                                            type="checkbox"
                                            name="isSeller"
                                        ...
                                        />
                                        <div className={`absolute inset-0 bg-neutral-900 rounded-[2px] transition-transform duration-200 flex items-center justify-center ${formData.isSeller ? 'scale-100' : 'scale-0'}`}>
                                            <svg className="w-3 h-3 text-white" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.6666 3.5L5.24992 9.91667L2.33325 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-neutral-900">Register as Seller</p>
                                    </div>
                                </label>
                            </div>
        ...
        >
            ...
            <span>Continue with Google</span>
                        ...
                        <p className="mt-6 text-center text-sm text-neutral-600">
                            ...
                            <Link to="/login" className="font-semibold text-neutral-900 hover:text-neutral-700 hover:underline underline-offset-4">
                                Sign In
                            </Link>
                        </p>
                    </div>
